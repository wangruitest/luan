  ...
  <head>
	...
	<script>
		...
		function loadData(){
			...
			ProvinceReceiveTouristAction.getCityMonthTourist(obj,function(result){
		...
		//没10分钟刷新一次后台数据
		function refresh(){
			setTimeout('loadData()',datafreshTime);//定时刷新
		}
		...
		//	setInterval('sjData()', refreshTime);
...
<body class="bg">
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="layout">
		<tr>
          <td width="25%" valign="top" class="radius_box"><h2 class="green_title">本月接待统计（<span id="sydate">0</span>）</h2>
