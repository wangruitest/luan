...
<head>
    ...
    <script>
        ...
        function getSearchForm1(){
            var pObj1 = {};
            pObj1.searchType = $('#searchtype').val();
            pObj1.beginTime = $("#"+pObj.searchType + "BeginTime").val();
            pObj1.endTime = $("#"+pObj.searchType + "EndTime").val();
            pObj1.cityid = $('#cityid').val();
            pObj1.countyid = $('#countyid').val();
            pObj1.qBegin = $('#qQuarterBegin').val();
            pObj1.qEnd = $("#qQuarterEnd").val();
            pObj1.aLevel=$("#aLevel").val();
            return pObj1;
        }
        ...
        if (isShowTb) {
            ...
            var dateParams1 = [eTime, bTime];
            showMSEChart(pObj, dateParams1, getStaticObject());
        } else {
            showMSEChart(pObj, dateParams, getStaticObject());
        }
