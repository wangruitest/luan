...
<table id="RegionRealtimeSumAddQueryForm" class="form_query" style="height: 65px;background-color: #E3EFFF;">
    <tr>
        <td>
            ...
            城市列表：<select id="RegionRealtimeSumAddQueryForm:cityCode" onchange="initCountyList();"
                         style="width:100px;"></select>
           区县列表：<select id="countyid" style="width:100px;" onchange="levelChange1();"></select>
            景区评级：<select id="RegionRealtimeSumAddQueryForm:aLevel" onchange="levelChange1();"
                         style="width:100px;">
