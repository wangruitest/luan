...
<div id="RegionRemainQueryForm" class="form_query" >
    <div>
        ...
        <label>所属地市:</label>
        <select id="RegionRemainQueryForm:cityCode" name="RegionRemainQueryForm:cityCode" onchange="initCountyList();" style="width:100px;"></select>
        <label>所属区县:</label>
        <select id="countyid" name="countyid" onchange="levelChange1();" style="width:100px;"></select>
        <label>景区评级:</label>
        <select id="RegionRemainQueryForm:aLevel" onchange="levelChange1();" >
    ...
    <div>
        ...
        <span style="display: none;" id="ySearch">
            ...
            <input type="text" style="width:100px;" id="RegionRemainQueryForm:ybegintime" name="RegionRemainQueryForm:ybegintime" class="Wdate" value="<%=today%>"
                                    onfocus="WdatePicker({errDealMode:0,dateFmt:'yyyy',minDate:'#F{$dp.$D(\'RegionRemainQueryForm:yendtime\',{y:-10})}',maxDate:'#F{$dp.$D(\'RegionRemainQueryForm:yendtime\')||\'%y\'}'});"/>
            <label>结束时间:</label><input type="text" style="width:100px;" id="RegionRemainQueryForm:yendtime" name="RegionRemainQueryForm:yendtime" class="Wdate" value="<%=today%>"
                        onfocus="WdatePicker({dateFmt:'yyyy',maxDate:'#F{$dp.$D(\'RegionRemainQueryForm:ybegintime\',{y:10})}',minDate:'#F{$dp.$D(\'RegionRemainQueryForm:ybegintime\')}'});"/>
        </span>
        <span style="display: none;" id="qSearch">
            <label>开始时间:</label><input type="text" style="width:100px;" id="RegionRemainQueryForm:qbegintime" name="RegionRemainQueryForm:qbegintime" class="Wdate" value="<%=today%>"
                                    onfocus="WdatePicker({errDealMode:0,dateFmt:'yyyy',minDate:'#F{$dp.$D(\'RegionRemainQueryForm:qendtime\',{y:-1})}',maxDate:'#F{$dp.$D(\'RegionRemainQueryForm:qendtime\')||\'%y\'}'});"/>
            ...
            <input type="text" style="width:100px;" id="RegionRemainQueryForm:qendtime" name="RegionRemainQueryForm:qendtime" class="Wdate" value="<%=today%>"
                        onfocus="WdatePicker({dateFmt:'yyyy',maxDate:'#F{($dp.$D(\'RegionRemainQueryForm:qbegintime\',{y:1}))}',minDate:'#F{$dp.$D(\'RegionRemainQueryForm:qbegintime\')}'});"/>
        ...
        <span style="display: none;" id="mSearch">
            ...
            <input type="text" style="width:100px;" id="RegionRemainQueryForm:mbegintime" name="RegionRemainQueryForm:mbegintime" class="Wdate" 
                                    onfocus="WdatePicker({dateFmt:'yyyy-MM',minDate:'#F{$dp.$D(\'RegionRemainQueryForm:mendtime\',{M:-10})}',maxDate:'#F{$dp.$D(\'RegionRemainQueryForm:mendtime\')||\'%y-%M\'}'});"/>
            <label>结束时间:</label>
            <input type="text" style="width:100px;" id="RegionRemainQueryForm:mendtime" name="RegionRemainQueryForm:mendtime" class="Wdate"
                        onfocus="WdatePicker({dateFmt:'yyyy-MM',maxDate:'#F{($dp.$D(\'RegionRemainQueryForm:mbegintime\',{M:10}))}',minDate:'#F{$dp.$D(\'RegionRemainQueryForm:mbegintime\')||\'%y-%M\'}'});"/>
        </span>
