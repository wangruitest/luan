...
*/
//luojz
function init_input(that){
  var object1=eval(that);
  if(object1=="undefined")return;
  try{
    object1.style.border="1px solid navy";
    object1.style.width="100px";
    object1.style.height="21px";
    object1.style.fontSize="12px";
    object1.style.backgroundImage="url(../../images/dhtmlx/calendar.gif)";
    object1.style.backgroundRepeat="no-repeat";
    object1.style.backgroundPosition="right";
  }catch(Ex){
    //alert(Ex);
  }
}
...
function dhtmlxDblCalendarObject(contId, isAutoDraw, options){this.scriptName = 'dhtmlxcalendar.js';this.entObj = document.createElement("DIV");this.winHeader = null
 ...
 {options = {};for (i in base)options [i] = base [i]};/**luojz**/init_input(base);/**luojz**/;this.isAutoDraw = base.autoDraw || isAutoDraw || false;this.contId = base.parent || base;this.scriptName = 'dhtmlxcalendar.js';this.date = [this.cutTime(new Date())];this.selDate = [this.cutTime(new Date())];this.curDate = this.cutTime(new Date());this.entObj = document.createElement("DIV");this.monthPan = document.createElement("TABLE");this.dlabelPan = document.createElement("TABLE");this.daysPan = document.createElement("TABLE");this.parent = null;this.style = "dhtmlxcalendar";this.skinName = dhtmlx.skin || "";this.doOnClick = null;this.sensitiveFrom = null;this.sensitiveTo = null;this.insensitiveDates = null;this.activeCell = null;this.hotCell = null;this.winHeader = null
