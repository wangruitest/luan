package com.funo.touristroamingovernightnodul.action;
...
public class TouristRoamingOvernightAction extends CommonAction{
	private ITouristRoamingOvernightMgmt touristRoamingOvernightMgmt;

	public ITouristRoamingOvernightMgmt getTouristRoamingOvernightMgmt() {
		return touristRoamingOvernightMgmt;
	}
	public void setTouristRoamingOvernightMgmt(ITouristRoamingOvernightMgmt touristRoamingOvernightMgmt) {
		this.touristRoamingOvernightMgmt = touristRoamingOvernightMgmt;
	}
	...
	public ActionResult getAllTouristRoamingOvernight(){
		ActionResult ar=new ActionResult();
		List result=null;
		try {
			result = touristRoamingOvernightMgmt.queryTouristRoamingOvernight(new TouristRoamingOvernight());
	 ...
	 */
	@SuppressWarnings({ "rawtypes", "unchecked" })
	public ActionResult getTouristRoamingOvernightList(TouristRoamingOvernight touristRoamingOvernight){
		ActionResult ar=new ActionResult();
		List result=null;
		try {
			result = touristRoamingOvernightMgmt.queryTouristRoamingOvernight(touristRoamingOvernight);
			if(result.size()<1){
				ar.setReturnList(result);
				ar.setResultCode(2);
			}else{
	...
	@SuppressWarnings({ "rawtypes", "unchecked" })
	public String getTouristRoamingOvernightList2(TouristRoamingOut2 touristRoamingOut){
		String result="{";
		...
		try {
			...
			resultList = touristRoamingOvernightMgmt.queryTouristRoamingOvernight2(touristRoamingOut);
	...
	public TouristRoamingOvernight totalRoaming(List list){
		Long totalsum= 0l;
	 ...
	 * 导出excel
	 * **/
	public ActionResult expExcel(TouristRoamingOvernight touristRoamingOvernight){
		ActionResult ar=new ActionResult();
		List<Object> list;
		list = getTouristRoamingOvernightList(touristRoamingOvernight).getReturnList();
		String titleStr = touristRoamingOvernight.getSearchTitlestr();
...
//					"阜阳过夜","宿州过夜","六安过夜","亳州过夜","池州过夜","宣城过夜"};
	...
	public ActionResult expExcel2(TouristRoamingOut2 touristRoamingOut,String number){
		...
		if(countyid!=null&&countyid!=""){
			area=touristRoamingOvernightMgmt.queryByCounty(countyid);
		}else{
			area=touristRoamingOvernightMgmt.queryByCityid(Constants.CITY_CODE);
		}
		...
		list2=touristRoamingOvernightMgmt.queryTouristRoamingOvernight2(touristRoamingOut);
