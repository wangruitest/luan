...
var obj={cityCode:mapcitycode};
RegionCoordsAction.getTOP4RegionInfoByCityDayView(mapcitycode,function(result){
			if(result.resultCode=="0"){
				var count="<tr><th align='left'>景区</th><th align='center'>温度</th><th align='center'>PM2.5</th><th align='center'>在园人数</th><th align='center'>拥堵情况</th></tr>";
...
<body style="background:#ffffff;margin-top: -2px;">
   <table width="99%" border="0" cellpadding="0"  class="layout">
    <tr valign="top">
     ...
     <td width="60%" class="radius_box"><h2 class="red_title">景区游客（本地+外地）接待TOP4</h2>
