...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $("#RegionRealtimeSumList").datagrid({
            ...
            columns: [[
                ...
                {field: 'stourists', title: '游客总量', width: 100},
    ...
    function loadData(data) {
        ...
        if (data != null && data.length > 0){
            $('#RegionRealtimeSumList').datagrid({loadFilter:pagerFilter}).datagrid('loadData', {total:data.length,rows:data});
        } else {
    ...
    function downloadExcel() {
        ...
        RegionRealtimeSumAction.expExcel(queryObj, function (result) {
