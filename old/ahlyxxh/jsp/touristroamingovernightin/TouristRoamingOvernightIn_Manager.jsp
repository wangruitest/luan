...
<html>
  <head>
	...
	<script type='text/javascript' src='${home}/dwr/interface/TouristRoamingOvernightInAction.js'></script>
	...
	<jsp:include flush='true' page='TouristRoamingOvernightIn_Manager_js.jsp'></jsp:include>

  </head>
  
  <body  style="margin:0px">	
		<div id="TouristRoamingOvernightInQueryForm" class="form_query1 parameter" style="">
			<div style="height:auto;">
				<span align="right" width="120px";>来源地：</span>
			...
			<label align="right" width="120px";>目的地：</label>
				...
				<label align="right" width="120px";>统计月份：</label>
						<input type="text" style="width:100px" id="TouristRoamingOvernightInQueryForm:statMonth" name="TouristRoamingOvernightInQueryForm:statMonth" class="Wdate" onclick="WdatePicker({dateFmt:'yyyy-MM',maxDate:'%y-#{%M}'});" readonly="readonly"/>											
		...
		<table id="TouristRoamingOvernightInList"></table>
