...
<script type="text/javascript">
    ...
    function loadData(data) {
        ...
        if (data != null && data.length > 0) {
            $('#RegionAlarmLevelList').datagrid({loadFilter:pagerFilter}).datagrid('loadData', {total:data.length,rows:data});
