...
<link rel="stylesheet" type="text/css" href="<%=path %>/css/libs/dataTables.fixedHeader.css">
<link rel="stylesheet" type="text/css" href="<%=path %>/css/libs/dataTables.tableTools.css">

<link rel="stylesheet" type="text/css"	href="<%=path %>/css/compiled/theme_styles.css" />

<link rel="stylesheet" href="<%=path %>/css/libs/fullcalendar.css" type="text/css" />
<link rel="stylesheet" href="<%=path %>/css/libs/fullcalendar.print.css"
	type="text/css" media="print" />
<link rel="stylesheet" href="<%=path %>/css/compiled/calendar.css" type="text/css"
	media="screen" />
<link rel="stylesheet" href="<%=path %>/css/libs/morris.css" type="text/css" />
<link rel="stylesheet" href="<%=path %>/css/libs/daterangepicker.css"
	type="text/css" />
<link rel="stylesheet" href="<%=path %>/css/libs/jquery-jvectormap-1.2.2.css"
	type="text/css" />
...
<body>
						...
						<li class="dropdown hidden-xs"><a class="btn dropdown-toggle"
							...
							<ul class="dropdown-menu notifications-list">
								...
								<li class="item"><a href="#"> <i class="fa fa-comment"></i>
										<span class="content">New comment on âAwesome P...</span> <span
						...
						<div class="collapse navbar-collapse navbar-ex1-collapse"
							...
							<ul class="nav nav-pills nav-stacked">
								...
								<li><a href="#" class="dropdown-toggle"> <i
									...
									<ul class="submenu">
										<li><a href="graphs-morris.html"> Morris &amp; Mixed
										</a></li>
								...
								<li><a href="widgets.html"> <i class="fa fa-th-large"></i>
										<span>Widgets</span> <span
										class="label label-success pull-right">New</span>
								</a></li>
								<li><a href="#" class="dropdown-toggle"> <i
										class="fa fa-desktop"></i> <span>Pages</span> <i
										class="fa fa-chevron-circle-right drop-icon"></i>
								</a>
									<ul class="submenu">
								...
								<li><a href="#" class="dropdown-toggle"> <i
									...
									<ul class="submenu">
										...
										<li><a href="form-summernote.html"> WYSIWYG
												Summernote </a></li>
										<li><a href="form-ckeditor.html"> WYSIWYG CKEditor </a></li>
										<li><a href="form-dropzone.html"> Multiple File
												Upload </a></li>
									</ul></li>
								<li><a href="#" class="dropdown-toggle"> <i
									...
									<ul class="submenu">
										...
										<li><a href="#" class="dropdown-toggle"> Icons <i
											...
											<ul class="submenu">
												...
												<li><a href="icons-halflings.html"> Halflings Icons
												</a></li>
											</ul></li>
										<li><a href="ui-nestable.html"> Nestable List </a></li>
										<li><a href="typography.html"> Typography </a></li>
										<li><a href="#" class="dropdown-toggle"> 3 Level Menu
								...
								<li><a href="#" class="dropdown-toggle"> <i
									...
									<ul class="submenu">
										...
										<li><a href="registration-full.html"> Registration
												Full </a></li>
										<li><a href="forgot-password.html"> Forgot Password </a>
										</li>
										<li><a href="forgot-password-full.html"> Forgot
												Password Full </a></li>
										<li><a href="lock-screen.html"> Lock Screen </a></li>
										<li><a href="lock-screen-full.html"> Lock Screen Full
										</a></li>
							...
							<div class="row">
								<div class="col-lg-3 col-sm-6 col-xs-12">
									<div class="main-box infographic-box">
										<i class="fa fa-user red-bg"></i> <span class="headline">Users</span>
										<span class="value"> <span class="timer"
											data-from="120" data-to="2562" data-speed="1000"
											data-refresh-interval="50"> 2562 </span>
										</span>
									</div>
								</div>
								<div class="col-lg-3 col-sm-6 col-xs-12">
									<div class="main-box infographic-box">
										<i class="fa fa-shopping-cart emerald-bg"></i> <span
											class="headline">Purchases</span> <span class="value">
											<span class="timer" data-from="30" data-to="658"
											data-speed="800" data-refresh-interval="30"> 658 </span>
										</span>
									</div>
								</div>
								<div class="col-lg-3 col-sm-6 col-xs-12">
									<div class="main-box infographic-box">
										<i class="fa fa-money green-bg"></i> <span class="headline">Income</span>
										<span class="value"> &#36;<span class="timer"
											data-from="83" data-to="8400" data-speed="900"
											data-refresh-interval="60"> 8400 </span>
										</span>
									</div>
								</div>
								<div class="col-lg-3 col-sm-6 col-xs-12">
									<div class="main-box infographic-box">
										<i class="fa fa-eye yellow-bg"></i> <span class="headline">Monthly
											Visits</span> <span class="value"> <span class="timer"
											data-from="539" data-to="12526" data-speed="1100">
												12526 </span>
										</span>
									</div>
								</div>
									...
									<div class="main-box clearfix">
										...
										<div class="filter-block pull-right">
											...
											<a href="#" class="btn btn-primary pull-right"> <i
												class="fa fa-eye fa-lg"></i> View all orders
											</a>
										</div>
										</header>
										<div class="main-box-body clearfix">
												...
												<table class="table table-hover">
													...
													<tbody>
														<tr>
															...
															<td class="text-right">&dollar; 825.50</td>
														...
														<tr>
															...
															<td class="text-right">&dollar; 923.93</td>
															<td class="text-center" style="width: 15%;"><a
																href="#" class="table-link"> <span class="fa-stack">
																		<i class="fa fa-square fa-stack-2x"></i> <i
																		class="fa fa-search-plus fa-stack-1x fa-inverse"></i>
														...
														<tr>
															...
															<td class="text-right">&dollar; 1.625.50</td>
															<td class="text-center" style="width: 15%;"><a
																href="#" class="table-link"> <span class="fa-stack">
																		<i class="fa fa-square fa-stack-2x"></i> <i
																		class="fa fa-search-plus fa-stack-1x fa-inverse"></i>
														...
														<tr>
															...
															<td class="text-right">&dollar; 35.34</td>
															<td class="text-center" style="width: 15%;"><a
																href="#" class="table-link"> <span class="fa-stack">
																		<i class="fa fa-square fa-stack-2x"></i> <i
																		class="fa fa-search-plus fa-stack-1x fa-inverse"></i>
														...
														<tr>
															...
															<td class="text-center"><span
																class="label label-success">Completed</span></td>
															<td class="text-right">&dollar; 34.199.99</td>
															<td class="text-center" style="width: 15%;"><a
																href="#" class="table-link"> <span class="fa-stack">
																		<i class="fa fa-square fa-stack-2x"></i> <i
																		class="fa fa-search-plus fa-stack-1x fa-inverse"></i>
							...
							<div class="row">
								<div class="col-md-4 col-sm-6 col-xs-12">
									<div class="main-box small-graph-box red-bg">
										<span class="value">2.562</span> <span class="headline">Users</span>
										<div class="progress">
										...
										<span class="subinfo"> <i
											class="fa fa-arrow-circle-o-up"></i> 10% higher than last
											week
										</span> <span class="subinfo"> <i class="fa fa-users"></i> 29
											new users
										</span>
									</div>
								</div>
								<div class="col-md-4 col-sm-6 col-xs-12">
									<div class="main-box small-graph-box emerald-bg">
										<span class="value">69.600</span> <span class="headline">Visits</span>
										<div class="progress">
											<div style="width: 84%;" aria-valuemax="100"
												aria-valuemin="0" aria-valuenow="84" role="progressbar"
												class="progress-bar">
												<span class="sr-only">84% Complete</span>
											</div>
										</div>
										<span class="subinfo"> <i
											class="fa fa-arrow-circle-o-down"></i> 22% less than last
											week
										</span> <span class="subinfo"> <i class="fa fa-globe"></i>
											84.912 last week
										</span>
									</div>
								</div>
								<div class="col-md-4 col-sm-6 col-xs-12 hidden-sm">
									<div class="main-box small-graph-box green-bg">
										<span class="value">923</span> <span class="headline">Orders</span>
										<div class="progress">
										...
										<span class="subinfo"> <i
											class="fa fa-arrow-circle-o-up"></i> 15% higher than last
											week
										</span> <span class="subinfo"> <i class="fa fa-shopping-cart"></i>
											8 new orders
										</span>
									</div>
								</div>
	...
	<script src="<%=path%>js/morris.min.js"></script>
	<script src="<%=path%>js/moment.min.js"></script>
	<script src="<%=path%>js/daterangepicker.js"></script>
	<script src="<%=path%>js/jquery-jvectormap-1.2.2.min.js"></script>
	<script src="<%=path%>js/jquery-jvectormap-world-merc-en.js"></script>
	<script src="<%=path%>js/gdp-data.js"></script>
	<script src="<%=path%>js/flot/jquery.flot.js"></script>
	...
	<script src="<%=path%>js/flot/jquery.flot.threshold.js"></script>
	<script src="<%=path%>js/jquery.countTo.js"></script>

	<script src="<%=path%>js/jquery.dataTables.js"></script>
	<script src="<%=path%>js/dataTables.fixedHeader.js"></script>
	<script src="<%=path%>js/dataTables.tableTools.js"></script>
