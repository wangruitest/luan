  ...
  <div class="main">
        ...
        <div class="part_container">
          ...
          <div class="part_body">
            <iframe class="perWeek" id="perWeek" src="<%=path %>/bigScreen/perWeek.jsp"
              style="border: none;width:100%;height:100%;" allowTransparency="true" frameborder="0" scrolling="no"
    ...
    <div class="main2">
      ...
      <div class="main2S main2_3">
        <div class="part_container">
          <div style="position: absolute;top:40px;right:20px;width:140px;height:35px;z-index:99999;">
            <div id="province0" class="switchButton switchButton1_1" onclick="changeProvince()">
              本省
            </div>
            <div id="province1" class="switchButton switchButton2_1" onclick="changeProvince()">
              外省
            </div>
          </div>
          <div class="part_title">昨日游客前十统计</div>
          <div class="part_body" style="    position: relative;">
            <div id="ben_sheng_body">
              <iframe class="ahmapArea" src="<%=path %>/bigScreen/ahmap.jsp"
                style="border: none;width:100%;height:100%;" allowTransparency="true" frameborder="0" scrolling="no"
                marginwidth="0" marginheight="0"></iframe>
    ...
    <div class="main3">
      ...
      <div class="main3S main3_1">
        <div class="part_container">
          ...
          <div class="part_body">
            <iframe class="sceneryArea" name="sceneryArea" id="sceneryArea" src="<%=path %>/bigScreen/scenery2.jsp"
              style="border: none;width:100%;height:100%;" allowTransparency="true" frameborder="0" scrolling="no"
              marginwidth="0" marginheight="0"> </iframe>
