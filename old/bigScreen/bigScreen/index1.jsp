...
<html>
	...
	<body>
		<div class="top">
			<ul>
			    ...
			    <li class="fl select region" style="text-align: center;">
	...
	<script type="text/javascript">
	 ...
	 getRegion();
	 var value1 = window.sessionStorage.getItem("regionId");
	 if(value1 !='' && value1 !=null){
	 	$('#region').val(value1);
	 }
	var regionId = $('select  option:selected').val();
    ...
    function func(){
		...
		//	 window.location.href="http://localhost:9090/ahlyxxh/bigScreen/index.jsp#-en";
			...
			$.ajax({
				...
				success:function(data){
					...
					for (var i=0;i<data.length;i++) {
						var varItem = new Option(data[i]['scenicName'],data[i]['scenicId']);
