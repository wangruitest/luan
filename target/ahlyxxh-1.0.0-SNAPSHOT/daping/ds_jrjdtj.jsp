  ...
  <head>
	...
	<script>
		...
		function reloadDate(data){
			...
			cur_num.setValue(parseInt(data.ykzs));
			$("#wsyksl").html(data.jwykrs+"");//外省游客数量
			$("#jwyksl").html(data.wsykrs+"");//境外游客数量
			$("#bsmyyksl").html(data.snmyrs+"");//本省漫游游客数量
		}
...
<body class="bg">
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="layout">
      ...
      <!--     <div class="space"> <img src="images/date05.png" width="231" height="62" /> -->  
               ...
               <div class="space">
               <p class="space2"></p>
              <p class="space2" style="font:14px/1.4 '微软雅黑';">本地游客数量：<span class="green" id="jwyksl">0</span></p>
               <p class="space2"></p>
               <p class="space2" style="font:14px/1.4 '微软雅黑';">本省外地游客数量：<span class="green" id="wsyksl">0</span></p>
               
               <p class="space2"></p>
              <p class="space2" style="font:14px/1.4 '微软雅黑';">外省游客数量：<span class="green" id="bsmyyksl">0</span> </p>
      			</div>
           </td>
        </tr>
	</table>
