...
<table id="RegionRealtimeSumQueryForm" class="form_query" style="height: 50px;background-color: #E3EFFF;">
    <tr>
        <td>
            &nbsp;&nbsp;城市列表：<select id="RegionRealtimeSumQueryForm:cityCode" name="RegionRealtimeSumQueryForm:cityCode"
                         onchange="initCountyList();" style="width:100px;"></select>
      区县列表：<select id="countyid" name="countyid" style="width:100px;" onchange="levelChange1();"></select>
            景区评级：<select id="RegionRealtimeSumQueryForm:aLevel" onchange="levelChange1();"
                         style="width:100px;">
            ...
            景区：<select id="RegionRealtimeSumQueryForm:regionId" style="width:100px;"></select>
            统计日期：<input type="text" id="RegionRealtimeSumQueryForm:begindate"
