...
<div id="RegionAlarmPhoneDialog" style="padding:25px;width:380px;height:250px;">
    <table id="RegionAlarmPhoneForm" class="form_table" style="height:100%;">
        ...
        <tr>
            ...
            <td>
                <input type="text" id="RegionAlarmPhoneForm:regions" validation="require" readonly="readonly" style="width:62%;background-color: #cad0cd"/>
