...
<table id="ReceiverToursitForm" class="form_query" style="height:50px;background-color: #E3EFFF;width:100%;">
    <tr>
        <td>
       &nbsp;&nbsp;
            选择地市：<select id="ReceiverToursitQueryForm:cityCode" name="ReceiverToursitQueryForm:cityCode" style="width:150px;"  onchange="initCountyList()"></select>
            选择区县：<select id="ReceiverToursitQueryForm:countyCode" name="ReceiverToursitQueryForm:countyCode" style="width:150px;"></select>
