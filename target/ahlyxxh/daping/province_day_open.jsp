...
<div id="fullscreenbtn" style="text-align: center;">
    ...
    <img id="fullscreenbox" style="width: 726px;height: 380px;" src="<%=request.getContextPath() %>/daping/images/province_day.png" alt="点击切换到全屏" />
</div>
<br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/>
<br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/>
<iframe id="fz618Detail" style="width: 100%" src="<%=request.getContextPath() %>/daping/province_day_view.jsp"></iframe>
