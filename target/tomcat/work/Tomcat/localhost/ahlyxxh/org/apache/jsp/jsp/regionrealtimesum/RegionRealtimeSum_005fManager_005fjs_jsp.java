 ...
 * Generated at: 2017-06-09 02:44:50 UTC
 * Note: The last modified time of this file was set to
 *       the last modified time of the source file after
 *       generation to assist with modification tracking.
 */
package org.apache.jsp.jsp.regionrealtimesum;

import javax.servlet.*;
import javax.servlet.http.*;
import javax.servlet.jsp.*;

public final class RegionRealtimeSum_005fManager_005fjs_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\r\n");
      out.write("        //创建列表\r\n");
      out.write("        $(\"#RegionRealtimeSumList\").datagrid({\r\n");
      out.write("            title:'景区实时流量统计',\r\n");
      ...
      out.write("                {field: 'localstourists', title: '本地游客', width: 100},\r\n");
      out.write("                {field: 'instourists', title: '省内游客', width: 100},\r\n");
      out.write("                {field: 'outstourists', title: '省外游客', width: 100},\r\n");
      out.write("                {field: 'stourists', title: '游客总量（人次）', width: 100},\r\n");
      ...
      out.write("        var date = $(\"#RegionRealtimeSumQueryForm\\\\:begindate\").val();\r\n");
      out.write("        var currentdate = new Date().pattern(\"yyyy-MM-dd\");\r\n");
      out.write("        if (\"\" == date) {\r\n");
      out.write("            date = currentdate;\r\n");
      out.write("            $(\"#RegionRealtimeSumQueryForm\\\\:begindate\").val(date);\r\n");
      out.write("        }\r\n");
      out.write("    }\r\n");
      out.write("\r\n");
      out.write("\t\tfunction initCountyList(){\r\n");
      out.write("\t\t\t\t\tvar cityid = document.getElementById(\"RegionRealtimeSumQueryForm:cityCode\").value;\r\n");
      ...
      out.write("\r\n");
      out.write("        $('#RegionRealtimeSumList').datagrid('unselectAll');\r\n");
      out.write("        var region = $(\"#RegionRealtimeSumQueryForm\\\\:regionId\").val();\r\n");
      out.write("        var time = $(\"#RegionRealtimeSumQueryForm\\\\:begindate\").val();\r\n");
      ...
      out.write("            regionId: $(\"#RegionRealtimeSumQueryForm\\\\:regionId\").val(),\r\n");
      out.write("            begindate: $(\"#RegionRealtimeSumQueryForm\\\\:begindate\").val(),\r\n");
      out.write("            cityCode: $(\"#RegionRealtimeSumQueryForm\\\\:cityCode\").val(),\r\n");
      out.write("            type: $(\"#RegionRealtimeSumQueryForm\\\\:type\").val(),\r\n");
      out.write("            holiday: $(\"#RegionRealtimeSumQueryForm\\\\:holiday\").attr(\"checked\") ? 'yes' : null,//有值则代表条件生效\r\n");
      ...
      out.write("        $(\"#RegionRealtimeSumQueryForm\\\\:id\").val('');\r\n");
      out.write("        $(\"#RegionRealtimeSumQueryForm\\\\:regionId\").val('');\r\n");
      out.write("        $(\"#RegionRealtimeSumQueryForm\\\\:stayTourists\").val('');\r\n");
      out.write("        $(\"#RegionRealtimeSumQueryForm\\\\:inTourists\").val('');\r\n");
      out.write("        $(\"#RegionRealtimeSumQueryForm\\\\:outTourists\").val('');\r\n");
      out.write("        $(\"#RegionRealtimeSumQueryForm\\\\:statHour\").val('');\r\n");
      out.write("        $(\"#RegionRealtimeSumQueryForm\\\\:updatetime\").val('');\r\n");
      out.write("        $(\"#RegionRealtimeSumQueryForm\\\\:cityCode\").val('');\r\n");
      out.write("        $(\"#RegionRealtimeSumQueryForm\\\\:submitTime\").val('');\r\n");
      out.write("        $(\"#RegionRealtimeSumQueryForm\\\\:type\").val('');\r\n");
      out.write("        $(\"#RegionRealtimeSumQueryForm\\\\:holiday\").attr(\"checked\", false);\r\n");
      out.write("    }\r\n");
      out.write("\r\n");
      out.write("    //加载表格数据\r\n");
      ...
      out.write("            $('#RegionRealtimeSumList').datagrid({loadFilter:pagerFilter}).datagrid('loadData', {total:data.length,rows:data}).datagrid('getPager').pagination('select',1);\r\n");
      out.write("        } else {\r\n");
      out.write("            $('#RegionRealtimeSumList').datagrid('loadData', {total: 0, rows: []});\r\n");
      out.write("        }\r\n");
      out.write("    }\r\n");
      out.write("\r\n");
      out.write("    function downloadExcel() {\r\n");
      out.write("        var number=\"3,4,5,6\";\r\n");
      out.write("        var queryObj = {\r\n");
      out.write("            regionId: $(\"#RegionRealtimeSumQueryForm\\\\:regionId\").val(),\r\n");
      out.write("            begindate: $(\"#RegionRealtimeSumQueryForm\\\\:begindate\").val(),\r\n");
      out.write("            cityCode: $(\"#RegionRealtimeSumQueryForm\\\\:cityCode\").val(),\r\n");
      ...
      out.write("            codeGenerator: 'codeGenerator'\r\n");
      out.write("        };\r\n");
      out.write("        RegionRealtimeSumAction.expExcel(queryObj,number, function (result) {\r\n");
      ...
      out.write("        var obj = $(\"#RegionRealtimeSumForm\").getJSON().RegionRealtimeSumForm;\r\n");
      out.write("        return obj;\r\n");
      out.write("    }\r\n");
      out.write("\r\n");
      out.write("    function reLoadGridData(queryObj) {\r\n");
      out.write("        hiddenDiv(\"RegionRealtimeSumListCHART\");\r\n");
      out.write("        hiddenDiv(\"RegionRealtimeSumListLine\");\r\n");
      out.write("        var tbshow = document.getElementById(\"showTb\").checked;\r\n");
      out.write("        var textval = \"统计显示各个景区在整点时间的实时在园游客数量，可选择景点和日期查询，可同比显示去年同期的统计。\";\r\n");
      out.write("        createSubDiv(\"RegionRealtimeSumListCHART\", 0);\r\n");
      out.write("        createSubDiv(\"RegionRealtimeSumListLine\", 0);\r\n");
      out.write("        RegionRealtimeSumAction.getRegionRealtimeSumList(queryObj, function (result) {\r\n");
      out.write("            if (result.resultCode == \"0\") {\r\n");
      ...
      out.write("                        var barDiv = document.getElementById(\"RegionRealtimeSumListCHART0\");\r\n");
      ...
      out.write("                        var lineDiv = document.getElementById(\"RegionRealtimeSumListLine0\");\r\n");
      ...
      out.write("            createSubDiv(\"RegionRealtimeSumListCHART\", 1);\r\n");
      out.write("            createSubDiv(\"RegionRealtimeSumListLine\", 1);\r\n");
      out.write("            RegionRealtimeSumAction.getRegionRealtimeSumList(queryObj1, function (result1) {\r\n");
      out.write("                if (result1.resultCode == \"0\") {\r\n");
      out.write("                    var height = document.documentElement.clientHeight-108;\r\n");
      out.write("                    try{\r\n");
      out.write("                        var obj = result1.returnObject;\r\n");
      out.write("                        var barOption = eval(\"(\" + obj[0] + \")\");\r\n");
      out.write("                        var barDiv = document.getElementById(\"RegionRealtimeSumListCHART1\");\r\n");
      out.write("                        barDiv.style.height=height+\"px\";\r\n");
      out.write("                        var barChart = echarts.init(barDiv);\r\n");
      out.write("                        barChart.clear();\r\n");
      out.write("                        barChart.setOption(barOption);\r\n");
      ...
      out.write("                    try{\r\n");
      out.write("                        var lineOption = eval(\"(\" + obj[1] + \")\");\r\n");
      out.write("                        var lineDiv = document.getElementById(\"RegionRealtimeSumListLine1\");\r\n");
      out.write("                        lineDiv.style.height=height+\"px\";\r\n");
      out.write("                        var lineChart = echarts.init(lineDiv);\r\n");
      out.write("                        lineChart.clear();\r\n");
      out.write("                        lineChart.setOption(lineOption);\r\n");
      ...
      out.write("        var cityid = document.getElementById(\"RegionRealtimeSumQueryForm:cityCode\").value;\r\n");
      out.write("        var aLevel = document.getElementById(\"RegionRealtimeSumQueryForm:aLevel\").value;\r\n");
      out.write("        var regionId = document.getElementById(\"RegionRealtimeSumQueryForm:regionId\");\r\n");
      ...
      out.write("           // document.getElementById(\"RegionRealtimeSumQueryForm:regionId\").disabled = true;\r\n");
      out.write("           // document.getElementById(\"RegionRealtimeSumQueryForm:aLevel\").disabled = true;\r\n");
      out.write("        } else {\r\n");
      out.write("            document.getElementById(\"RegionRealtimeSumQueryForm:regionId\").disabled = false;\r\n");
      out.write("            document.getElementById(\"RegionRealtimeSumQueryForm:aLevel\").disabled = false;\r\n");
      out.write("        }\r\n");
      ...
      out.write("        var regionId = document.getElementById(\"RegionRealtimeSumQueryForm:regionId\");\r\n");
      out.write("        //removeAllOptions();//删除已有的option\r\n");
      out.write("        $('#RegionRealtimeSumQueryForm\\\\:regionId option:selected').text(\"\");\r\n");
      out.write("        $(\"#RegionRealtimeSumQueryForm\\\\:regionId\").empty();\r\n");
      out.write("        if (cityid=='') {\r\n");
      out.write("            return;\r\n");
      out.write("        }\r\n");
      out.write("        if(aLevel==''){\r\n");
      ...
      out.write("        var cityid = document.getElementById(\"RegionRealtimeSumQueryForm:cityCode\");\r\n");
      out.write("        dwr.engine.setAsync(false);\r\n");
      ...
      out.write("        var region = document.getElementById(\"RegionRealtimeSumQueryForm:regionId\");\r\n");
