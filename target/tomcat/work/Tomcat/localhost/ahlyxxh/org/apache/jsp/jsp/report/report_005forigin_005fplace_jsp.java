 ...
 * Generated at: 2019-05-24 02:09:04 UTC
...
public final class report_005forigin_005fplace_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	String day=DateUtil.format(DateUtil.getDateAfter(date, -1), "yyyy-MM-dd");
      ...
      out.write("        var regionName = $('#regionId').find('option:selected').text();\r\n");
      out.write("        tObject.regionId = $('#regionId').val();\r\n");
      out.write("        var regionName = regionName;\r\n");
      out.write("        tObject.xname = \"单位（省市）\";\r\n");
      out.write("        tObject.yname = \"单位（人次）\";\r\n");
      out.write("        tObject.caption = regionName + \"游客来源地统计\";\r\n");
      out.write("        tObject.subTitle = \"针对各个景区，按照来源地进行统计游客数量，可按年、季度、月统计。\";\r\n");
      out.write("        tObject.axisLabel={interval:0,formatter:function(val){\r\n");
      out.write("            return val.split('').join('\\n');\r\n");
      out.write("        }};\r\n");
      out.write("        tObject.procedureName = \" ");
      out.print(ReportConstants.ORGIN_PLACE_PROCEDURE);
      out.write("\";\r\n");
      out.write("        tObject.PROC_PARAMS = \"");
      out.print(ReportConstants.ORGIN_PLACE_PROCEDURE_PARAMS);
      out.write("\";\r\n");
      ...
      out.write("        var headerStr = [\"地区名称\", \"游客数量（人次）\", \"统计时间\", \"景区名称\"];\r\n");
      out.write("        var title = \"景区游客来源统计\";\r\n");
      out.write("        var pObj = getSearchForm();\r\n");
      out.write("        if(!valid(pObj)) return;\r\n");
      ...
      out.write("        var todaystr = myDate.getFullYear();\r\n");
      out.write("        if (searchtype == \"y\" && myDate.getMonth() == 0) {\r\n");
      out.write("            todaystr = (myDate.getFullYear() - 1);\r\n");
      out.write("        }\r\n");
      out.write("        $(\"#\"+searchtype + \"BeginTime\").val(todaystr);\r\n");
      out.write("        $(\"#\"+searchtype + \"EndTime\").val(todaystr);\r\n");
      out.write("    }\r\n");
      out.write("    \r\n");
      ...
      out.write("\t\t\t\t   var quanbu  = new Option('全部','0000');\r\n");
      ...
      out.print(ReportConstants.ORGIN_PLACE_PROCEDURE_PARAMS);
      out.write("\"/>\r\n");
      out.write("<input type=\"hidden\" id=\"areaCodes\" name=\"areaCodes\"/>\r\n");
      out.write("<input type=\"hidden\" id=\"provinces_code\" name=\"provinces_code\" value=\"");
      out.print(request.getParameter("provinces_code"));
      out.write("\"/>\r\n");
