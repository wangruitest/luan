...
public final class commonSelect_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	request.setAttribute("home", request.getContextPath());
      ...
      out.write("\t                参数说明：\r\n");
      out.write("\t     (1)options={\r\n");
      out.write("\t\t        type: 数据类型---必填，其中  01-选择人员,02-选择角色,03-选择预警人员\r\n");
      ...
      out.write("\t\t\tselectedUnids+=obj.unid+\";\";\r\n");
      ...
      out.write("\t\t\tSysOperatorAction.getSysOperatorList(null,function(result){\r\n");
      ...
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t});\r\n");
      out.write("\t\t}else if(options.type=='03'){\r\n");
      out.write("\t\t\tRegionAlarmLevelAction.queryRegions(function(result){\r\n");
      out.write("\t\t\t\tif(result.resultCode=='0'){\r\n");
      out.write("\t\t\t\t\t$(result.returnList).each(function(index,obj){\r\n");
      out.write("\t\t\t\t\t\tvar value=obj.regionId;\r\n");
      out.write("\t\t\t\t\t\tvar text=obj.regionName;\r\n");
      out.write("\t\t\t\t\t\tif(selectedUnids.indexOf(value+\";\")<0){\r\n");
      out.write("\t\t\t\t\t\t\t$(\"#common_toSelect\").append(\"<option value='\"+value+\"'>\"+text+\"</option>\");\r\n");
      out.write("\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t});\r\n");
