 ...
 * Generated at: 2017-09-11 02:21:49 UTC
...
public final class foreigncities_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	String day=DateUtil.format(DateUtil.getDateAfter(date, -1), "yyyy-MM-dd");
      ...
      out.write("    <title>省外地市游客来源地分析</title>\r\n");
      ...
      out.write("                {field: 'city', title: '地区名称', width: 100},\r\n");
      out.write("                {\r\n");
      out.write("                    field: 'ABC', title: '游客数量（人次）', width: 100, formatter: function (index, obj) {\r\n");
      out.write("                    if (null == obj)return \"\";\r\n");
      out.write("                    var result = obj['sumtourists'];\r\n");
      out.write("                    if (null == result)result = \"\";\r\n");
      ...
      out.write("            $('#ForeignCitiesSumList').datagrid({loadFilter:pagerFilter}).datagrid('loadData', {total:data.length,rows:data}).datagrid('getPager').pagination('select',1);\r\n");
      out.write("        } else {\r\n");
      ...
      out.write("                }\r\n");
      out.write("            } else {\r\n");
      out.write("                showMsg(\"省外地市游客来源地分析数据时出错，可能原因为：\\n\" + result.resultMessage);\r\n");
      out.write("            }\r\n");
      out.write("        });\r\n");
      out.write("    }\r\n");
      out.write("\r\n");
      ...
      out.write("            return false;\r\n");
      out.write("        }\r\n");
      out.write("        if (pObj.regionId == null) {\r\n");
      ...
      out.write("        </select>\r\n");
      out.write("        <label>选择景区:</label>\r\n");
      out.write("        <select id=\"regionId\" name=\"regionId\" ></select>\r\n");
      out.write("        <label>选择游客来源省份:</label>\r\n");
      out.write("        <select  id=\"foreignprovince\" name=\"foreignprovince\">\r\n");
      out.write("        </select>\r\n");
      ...
      out.write("            <option value=\"d\">按日期统计</option>\r\n");
      out.write("        </select>\r\n");
      ...
      out.write("            <input type=\"text\"  id=\"yEndTime\" name=\"yEndTime\"\tvalue=\"");
      out.print(today );
      out.write("\" class=\"Wdate\" onfocus=\"WdatePicker({dateFmt:'yyyy',maxDate:'#F{$dp.$D(\\'yBeginTime\\',{y:10})}',minDate:'#F{$dp.$D(\\'yBeginTime\\')}'});\" />\r\n");
      out.write("        </span>\r\n");
      out.write("        <span style=\"display: none;\" id=\"qSearch\">\r\n");
      out.write("            <label>开始时间:</label>\r\n");
      out.write("            <input type=\"text\"  id=\"qBeginTime\" name=\"qBeginTime\" value=\"");
      out.print(today );
      out.write("\" class=\"Wdate\" onfocus=\"WdatePicker({dateFmt:'yyyy',minDate:'#F{$dp.$D(\\'qEndTime\\',{y:-1})}',maxDate:'#F{$dp.$D(\\'qEndTime\\')||\\'%y\\'}'});\" />\r\n");
      ...
      out.write("            </select>\r\n");
      out.write("            <label>结束时间:</label>\r\n");
      out.write("            <input type=\"text\"  id=\"qEndTime\" name=\"qEndTime\" value=\"");
      out.print(today );
      out.write("\" class=\"Wdate\" onfocus=\"WdatePicker({dateFmt:'yyyy',maxDate:'#F{($dp.$D(\\'qBeginTime\\',{y:1}))}',minDate:'#F{$dp.$D(\\'qBeginTime\\')}'});\" />\r\n");
      ...
      out.write("            <label>开始时间:</label>\r\n");
      out.write("            <input type=\"text\"  id=\"mBeginTime\" name=\"mBeginTime\" value=\"");
      out.print(month );
      out.write("\" class=\"Wdate\" onfocus=\"WdatePicker({dateFmt:'yyyy-MM',minDate:'#F{$dp.$D(\\'mEndTime\\',{M:-10})}',maxDate:'#F{$dp.$D(\\'mEndTime\\')||\\'%y-%M\\'}'});\" />\r\n");
      out.write("            <label>结束时间:</label>\r\n");
      ...
      out.write("        <a class=\"easyui-linkbutton\" name=\"searchbtn2\" id=\"searchbtn2\" onclick=\"exportJc();\">导出Excel</a>\r\n");
      out.write("    </div>\r\n");
      out.write("</div>\r\n");
      out.write("\r\n");
