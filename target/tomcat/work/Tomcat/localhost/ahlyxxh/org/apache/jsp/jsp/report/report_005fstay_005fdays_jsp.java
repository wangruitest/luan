 ...
 * Generated at: 2019-05-22 15:17:55 UTC
...
public final class report_005fstay_005fdays_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("    <title>外地游客旅游天数统计</title>\r\n");
      out.write("    ");
      ...
      out.write("            title:'游客旅游天数统计',\r\n");
      out.write("            singleSelect: true,\r\n");
      out.write("            pagination: true,\r\n");
      out.write("            rownumbers:true,\r\n");
      out.write("            height:getViewportHeight()-100,\r\n");
      out.write("            pageSize: 20,\r\n");
      out.write("            border:false,\r\n");
      out.write("            fitColumns: true,\r\n");
      out.write("            columns: [[\r\n");
      out.write("                {field: 'RQ', title: '统计时间', width: 100},\r\n");
      out.write("                {field: '一日游', title: '一日游（人次）', width: 100},\r\n");
      out.write("                {field: '二日游', title: '二日游（人次）', width: 100},\r\n");
      out.write("                {field: '三日游', title: '三日游（人次）', width: 100},\r\n");
      out.write("                {field: '四日游', title: '四日游（人次）', width: 100},\r\n");
      out.write("                {field: '多日游', title: '多日游（人次）', width: 100}\r\n");
      out.write("            ]]\r\n");
      out.write("        });\r\n");
      out.write("        $(\"#tabs\").tabs({\r\n");
      out.write("            border:false,\r\n");
      ...
      out.write("            showMSEChart(pObj, params, getStaticObject());\r\n");
      ...
      out.write("            var dateParams = [eTime, bTime];\r\n");
      ...
      out.write("\t\t}\r\n");
      out.write("\t}\r\n");
      out.write("        var headerStr = [\"统计时间\", \"一日游（人次）\", \"二日游（人次）\", \"三日游（人次）\", \"四日游（人次）\", \"多日游（人次）\"];\r\n");
      out.write("        var title = \"游客旅游天数统计\";\r\n");
      out.write("        //var pObj = getSearchForm();\r\n");
      out.write("        var number =\"1,2,3,4,5\";\r\n");
      out.write("        var isShowTb = $('#showTb').attr(\"checked\");\r\n");
      out.write("        if(isShowTb){\r\n");
      out.write("            pObj.showTb = true;\r\n");
      out.write("        }\r\n");
      out.write("        var dateParams = [pObj.endTime, pObj.beginTime];\r\n");
      out.write("        showExport(pObj, dateParams, getStaticObject(), headerStr, title,number);\r\n");
      out.write("    }\r\n");
      out.write("\r\n");
      out.write("\r\n");
      out.write("    /**表头参数的定义*/\r\n");
      ...
      out.write("        tObject.caption = \"外地游客旅游天数统计\";\r\n");
      out.write("        tObject.subTitle= \"统计所有外地游客的旅游天数，可按年、季度、月统计，具体包括一日游、二日游、三日游、四日游、多日游，可同比显示去年同期的统计。\";\r\n");
      out.write("        tObject.procedureName = \"");
      out.print(ReportConstants.TOURIST_STAT_DAYS_PROCEDURE);
      out.write("\";\r\n");
      out.write("        tObject.PROC_PARAMS = \"");
      out.print(ReportConstants.TOURIST_STAT_DAYS_PROCEDURE_PARAMS);
      out.write("\";\r\n");
      out.write("        tObject.noSplit = \"yes\";\r\n");
      out.write("        tObject.chartTypes = \"");
      out.print(ReportConstants.MSCOUMN3D_CHART);
      out.write(',');
      out.print(ReportConstants.MSLINE_CHART);
      out.write("\";\r\n");
      ...
      out.write("        }\r\n");
      out.write("        today.setMonth(today.getMonth()-2);\r\n");
      ...
      out.write("        }\r\n");
      out.write("        $(\"#\"+searchtype + \"BeginTime\").val(beginMonth);\r\n");
      out.write("        $(\"#\"+searchtype + \"EndTime\").val(endMonth);\r\n");
      out.write("    }\r\n");
      ...
      out.write("\t\t\t\tif(data.returnList.length>1)countyid.prepend(\"<option value='0'>全部</option>\");\r\n");
      ...
      out.write("        <select id=\"cityid\" name=\"cityid\"></select>\r\n");
      ...
      out.write("            <label>开始时间:</label>\r\n");
      out.write("            <input type=\"text\" id=\"qBeginTime\" name=\"qBeginTime\" class=\"Wdate\" onfocus=\"WdatePicker({dateFmt:'yyyy',minDate:'#F{$dp.$D(\\'qEndTime\\',{y:-1})}',maxDate:'#F{$dp.$D(\\'qEndTime\\')||\\'%y\\'}'});\"  value=\"");
      out.print(year);
      out.write("\"/>\r\n");
      ...
      out.write("            </select>\r\n");
      out.write("            <label>结束时间:</label>\r\n");
      out.write("            <input type=\"text\" id=\"qEndTime\" name=\"qEndTime\" class=\"Wdate\" onfocus=\"WdatePicker({dateFmt:'yyyy',maxDate:'#F{($dp.$D(\\'qBeginTime\\',{y:1}))}',minDate:'#F{$dp.$D(\\'qBeginTime\\')}'});\"  value=\"");
      out.print(year);
      out.write("\"/>\r\n");
      ...
      out.write("            <label>开始时间:</label>\r\n");
      out.write("            <input type=\"text\" id=\"mBeginTime\" name=\"mBeginTime\" class=\"Wdate\" onfocus=\"WdatePicker({dateFmt:'yyyy-MM',minDate:'#F{$dp.$D(\\'mEndTime\\',{M:-10})}',maxDate:'#F{$dp.$D(\\'mEndTime\\')||\\'%y-%M\\'}'});\" />\r\n");
      out.write("            <label>结束时间:</label>\r\n");
      out.write("            <input type=\"text\" id=\"mEndTime\" name=\"mEndTime\" class=\"Wdate\" onfocus=\"WdatePicker({dateFmt:'yyyy-MM',maxDate:'#F{($dp.$D(\\'mBeginTime\\',{M:10}))}',minDate:'#F{$dp.$D(\\'mBeginTime\\')||\\'%y-%M\\'}'});\" />\r\n");
      out.write("        </span>\r\n");
