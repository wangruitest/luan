...
<html>
  <head>
	...
	<script type='text/javascript' src='${home}/dwr/interface/TouristRoamingOvernightAction.js'></script>
	...
	<jsp:include flush='true' page='TouristRoamingOvernight_Manager_js.jsp'></jsp:include>

  </head>
  
  <body  style="margin:0px">	
		<table id="TouristRoamingOvernightQueryForm" class="form_query1" style="height: 50px">
			<tr>
			...
			<tr>
				...
				<td>
					<input type="text" style="width:100px" id="TouristRoamingOvernightQueryForm:statMonth" name="TouristRoamingOvernightQueryForm:statMonth" class="Wdate" onclick="WdatePicker({dateFmt:'yyyy-MM',maxDate:'%y-#{%M}'});" readonly="readonly"/>										
		...
		<table id="TouristRoamingOvernightList"></table></div>
</body>
</html>
