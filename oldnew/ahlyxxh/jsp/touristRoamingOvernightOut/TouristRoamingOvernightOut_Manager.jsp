...
<html>
  ...
  <body style="margin:0px">	
		<table id="TouristRoamingOvernightOutQueryForm" class="form_query1" style="height: 50px">
			<tr>
			...
			<tr>
				...
				<td>
					<input type="text" style="width:100px"  id="TouristRoamingOvernightOutQueryForm:statMonth" name="TouristRoamingOvernightOutQueryForm:statMonth" class="Wdate" onclick="WdatePicker({dateFmt:'yyyy-MM',maxDate:'%y-#{%M}'});" readonly="readonly"/>
